	...
	<div class="wrapper">
        <form method="post" action="comment.php"> 			
            <div class="form-group">
				...
				<br>
                <input type="radio" id="rating" name="rating" value="Strong Reject (-3)"> Strong Reject ||
				<input type="radio" id="rating" name="rating" value="Reject (-2)"> Reject ||
				<input type="radio" id="rating" name="rating" value="Weak Reject (-1)"> Weak Reject ||
				<input type="radio" id="rating" name="rating" value="Borderline Paper (0)"> Borderline Paper ||
				<input type="radio" id="rating" name="rating" value="Weak Accept (1)"> Weak Accept ||
				<input type="radio" id="rating" name="rating" value="Accept (2)"> Accept ||
				<input type="radio" id="rating" name="rating" value="Strong Accept (3)"> Strong Accept
            </div>	 
			<div class="form-group">
				<label>Comment</label>
				<br/>
